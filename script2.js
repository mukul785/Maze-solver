document.addEventListener("DOMContentLoaded", () => {
    ...
    async function solveMaze(algorithm) {
        ...
        // Assuming you have a function that gets called when the maze is solved
    function onMazeSolved() {
        const maze = document.getElementById('maze');
        maze.classList.add('glow-border');

        // Optionally, you can remove the class after the animation ends
        setTimeout(() => {
            maze.classList.remove('glow-border');
